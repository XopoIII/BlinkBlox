...
| `E3005` | Reserved identifier | `StepReplication`, `SetRateLimitHandler`, `SetDecodeErrorHandler` and `SetPacketDropHandler` name module members. Rename the declaration. |
