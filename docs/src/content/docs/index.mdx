...
A thousand events a frame from client to server, run in Studio on 0.35.0. The numbers are median
frame rates, with the milliseconds a frame's thousand fires took in brackets.
