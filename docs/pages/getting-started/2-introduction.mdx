...
BlinkBlox's language is really simple, you will learn more throught the guide.<br />
...
BlinkBlox returns an immutable table with all of your events and functions.
