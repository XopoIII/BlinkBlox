...
Source code can be found here [here](https://github.com/XopoIII/blink/blob/main/benchmark/src).  
Data used for benchmarks can be found [here](https://github.com/XopoIII/blink/blob/main/benchmark/src/shared/benches).   
Defenition files used for benchmarks can be found [here](https://github.com/XopoIII/blink/blob/main/benchmark/definitions).  
 
## Results

`P[NUMBER]` = [NUMBER] Percentile  
*The tables below were automatically generated by this [script](https://github.com/XopoIII/blink/blob/main/benchmark/generate.luau).*
...
Memory #1: `17GB 4800`  
Memory #2: `17GB 4800`  
## [Entities](https://github.com/XopoIII/blink/blob/main/benchmark/src/shared/benches/Entities.luau)
...
## [Booleans](https://github.com/XopoIII/blink/blob/main/benchmark/src/shared/benches/Booleans.luau)
|Tool (FPS)|Median|P0|P80|P90|P95|P100|Loss (%)|
|---|---|---|---|---|---|---|---|
