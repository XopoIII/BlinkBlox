...
#
# The limit is 900 lines. Files that already exceed it are listed below WITH THEIR CURRENT SIZE, and
...
#
# The long files are long for a reason, not by accident -- a parser and a code generator are
# genuinely large pieces of work -- so this is a ratchet, not a demand to split them tomorrow.
#
